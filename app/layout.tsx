...
export const metadata: Metadata = {
  title: 'Next.js Week 1',
  description: 'Week 1 practice app',
};
      ...
      <body className="min-h-screen bg-white flex flex-col">
        ...
        <header className="border-b border-gray-100 px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-gray-800">Next.js W1</span>
          </div>
          <nav className="flex items-center gap-8">
            ...
            <Link href="/users/client" className="text-sm text-gray-600 hover:text-gray-900 transition-colors">
              Users (Client)
            </Link>
          </nav>
        </header>
          ...
          <div className="max-w-5xl mx-auto flex items-start justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 max-w-xs">
                Week 1 demo app — learning Server vs Client Components in Next.js.
              </p>
            </div>
